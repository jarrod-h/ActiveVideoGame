...
namespace ActiveVideoGame
{
    public partial class MainMenu : System.Web.UI.Page
    {
        ...
        private DataTable userMonsters = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                userMonsters = getUserMonsters(Convert.ToInt32(Session["UserId"]));
                monstersGrid1.DataSource = userMonsters;
                monstersGrid1.DataBind();
                //setMonsterValues();
                //updateInterface();
            }
        }

        private DataTable getUserMonsters(int UserId)
        {
            Monster userMonsters = new Monster();
            DataTable monstersList = userMonsters.ReturnMonsters(UserId);
            return monstersList;
        }

        protected void monstersGrid_DataBound(Object sender, EventArgs e)
        {
            //creates the table of viable challengers and renders their level and step
            //try
            //{
            //    for(int i = 0; i <= monstersGrid1.Rows.Count -1; i++)
            //    {
        ...
        //setMonsterValues() will likely be replaced once the gridview is implemented
