        ...
        <form id="frmRegister" runat="server">
            <div id="section">
                ...
                <div class="row">
                    ...
                    <asp:TextBox Class="txtInput" ID="txtFirstName" runat="server" placeholder="First Name">Alice</asp:TextBox>
                    
                </div>
                <div class="row">
                    User Name:
                    <asp:TextBox Class="txtInput" ID="txtUsername" runat="server" placeholder="Username">Alice</asp:TextBox>
                </div>
                <div class="row">
                    Surname:
                    ...
                    <asp:TextBox Class="txtInput" ID="txtLastName" runat="server" placeholder="Surname">Alice</asp:TextBox>
                ...
                <div class="row">
                    ...
                    <asp:TextBox Class="txtInput" ID="txtEmailAddress" runat="server" placeholder="Email" TextMode="Email">alice@alice.com</asp:TextBox>
                </div>
                <div class="row">
                    Parent Email:
                    ...
                    <asp:TextBox Class="txtInput" ID="txtParentEmailAddress" runat="server" placeholder="Parent Email" TextMode="Email">alice@alice.com</asp:TextBox>
                ...
                <div class="row">
                    ...
                    <asp:TextBox Class="txtInput" ID="txtPassword" runat="server" placeholder="Password" TextMode="Password">ABCabc123?!</asp:TextBox>
                ...
                <div class="row">
                    ...
                    <asp:TextBox Class="txtInput" ID="txtConfirmPassword" runat="server" placeholder="Confirm Password" TextMode="Password">ABCabc123?!</asp:TextBox>
